...
Complementary or \textit{synergetic} information quantifies the amount of information that both inputs have about the output, but if one of the inputs is removed, this information is lost. The complementary information is denoted as $CI(X:Y,Z)$. 
...
Now that the PID terms have been defined, we can decompose the mutual information four terms as follows:
...
It is also possible to decompose the information that a single variable, either $Y$ or $Z$, has about the output $X$: 
