...
Now, if we would find a distribution $Q_0 \in \Delta_P$ such that the synergy vanishes, we could find unique information, since from the chain rule for information \ref{chain-rule-inf} and decompositions \ref{pid} \ref{pid-yz}, the following identities can be trivially derived: 
